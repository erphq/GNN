...
def create_model(model_type: str, **kwargs) -> Any:
    ...
    if model_type in ['gnn', 'enhanced_gnn', 'lstm', 'enhanced_lstm']:
    ...
    if model_type in ['gnn', 'enhanced_gnn']:
        ...
        if 'use_positional_encoding' in kwargs:
            ...
            if use_pos and attention_type == 'basic':
                ...
                kwargs['attention_type'] = 'positional'
